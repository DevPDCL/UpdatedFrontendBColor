      ...
      <div className="hidden fixed md:block">
        <div>
          <Link to="/branch" target="_blank" rel="noopener noreferrer">
            <div className="flex gap-2 fixed top-[380px] right-0 opacity-60 hover:opacity-100 hover:cursor-pointer font-extrabold">
              <p className="font-ubuntu gradient-sidebar-flow">Hotline</p>
              <svg
                id=""
                class="w-[20px] h-[20px] mr-2 fill-gray-600"
                viewBox="0 0 512 512"
          ...
          <Link to="/" target="_blank" rel="noopener noreferrer">
            <div className="flex gap-2 fixed top-[420px] right-0 opacity-60 hover:opacity-100 hover:cursor-pointer font-extrabold">
              <p className="font-ubuntu gradient-sidebar-flow">Messanger</p>
              <svg
                id=""
                class="w-[20px] h-[20px] mr-2 fill-gray-600"
                viewBox="0 0 512 512"
          ...
          <Link to="/patient" target="_blank" rel="noopener noreferrer">
            <div className="flex gap-2 fixed top-[460px] right-0 opacity-60 hover:opacity-100 hover:cursor-pointer font-extrabold">
          ...
          <Link to="/" target="_blank" rel="noopener noreferrer">
            <div className="flex gap-2 fixed top-[540px] right-0 opacity-60 hover:opacity-100 hover:cursor-pointer font-extrabold">
              <p className="font-ubuntu gradient-sidebar-flow">
                Video Consutancy
              </p>
              <svg
          ...
          <Link to="/complain" target="_blank" rel="noopener noreferrer">
            <div className="flex gap-2 fixed top-[580px] right-0 opacity-60 hover:opacity-100 hover:cursor-pointer font-extrabold">
              <p className="font-ubuntu gradient-sidebar-flow">
                Complain Submition
              </p>
              <svg

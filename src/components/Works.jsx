...
const Works = () => {
  ...
  return (
    <>
      <div className=" absolute top-10 left-[15%] w-[30%] h-[50%] bg-[#B2D8B2] blur-3xl rounded-full opacity-40 mix-blend-multiply  animate-blob animation-delay-2000">
        {" "}
      </div>
      <div className=" absolute top-5 left-[35%] w-[30%] h-[50%]  bg-[#1b7ced] blur-3xl  rounded-full opacity-15 mix-blend-multiply animate-blob animation-delay-4000">
        {" "}
      </div>
      <div className=" absolute top-10 left-[50%] w-[30%] h-[50%] bg-[#B2D8B2] blur-3xl  rounded-full opacity-40 mix-blend-multiply animate-blob animation-delay-6000">
        {" "}
      </div>

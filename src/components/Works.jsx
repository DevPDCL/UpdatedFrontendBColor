  ...
  return (
    <>
      <div className="relative pt-10 fontFamily-ubuntu">
        <div className=" overflow-hidden  mt-[-140px] py-24 sm:py-32">
          ...
          <div className="mx-auto">
            <div className="mx-auto flex justify-evenly rounded-3xl bg-gradient-to-b from-transparent to-[#f0fff0]/60 py-5 px-20">
              <div className="lg:pr-8 lg:pt-4">
                <div className="grid md:grid-cols-4 items-center justify-center mx-auto ">
                  <div className="flex flex-col col-span-1 items-center  mx-auto group">
                    <div className="p-5 items-center flex flex-row gap-3 mx-auto text-center">
                      <div className=" rounded-full p-3 border-2 border-gray-600  group-hover:bg-gray-600">
                        <svg
                          className="w-[30px] h-[30px] fill-gray-600 group-hover:fill-white"
                          viewBox="0 0 640 512"
      ...
      <div className="w-full h-[400px] pt-20  relative justify-top items-bottom">
        ...
        <div
          className={` absolute  flex   max-w-7xl mx-auto inset-1 justify-center items-center text-center pt-[120px]  flex-col text-gray-900`}
        >
          ...
          <div className="flex flex-wrap">
            <button className="bg-none border text-white rounded mt-10 m-2 p-3 hover:bg-blue-500 hover:text-gray-900">
              Contact Now
            </button>
            <Link to="/">
              {" "}
              <button className="bg-none border text-white rounded mt-10 m-2 p-3 hover:bg-[#00664a] hover:text-gray-900">
                Learn More
              </button>
            </Link>
          </div>
